...
const achievements = [
  {
    ...
    label: t('aboutsectionhome.achievements.successProjects'),
  },
  {
    ...
    label: t('aboutsectionhome.achievements.simplicityDesign'),
  },
  {
    ...
    label: t('aboutsectionhome.achievements.constructionControl'),
  },
]

const stats = [
  { value: '200+', label: t('aboutsectionhome.stats.activeProjects') },
  { value: '99%', label: t('aboutsectionhome.stats.approvalRate') },
]
      ...
      <FadeInOnScroll>
        <div class="w-full flex flex-col gap-8" ref="statsRef">
          ...
          <div class="rounded-lg overflow-hidden shadow-lg">
            <img
              :src="image[0]"
              :alt="t('aboutsectionhome.imageAlt')"
